                        ...
                        <div className="w-full sm:w-1/2 p-6 sm:p-8">
                            ...
                            <div className="mt-8">
                                <button
                                    ...
                                    className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-accent hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent"
                                >
                                    Add to Bag
                                </button>
                            </div>
